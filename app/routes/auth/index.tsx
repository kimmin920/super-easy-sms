  ...
  return (
    <>
      <div className='container relative h-screen flex-col items-center justify-center grid lg:max-w-none lg:grid-cols-2 lg:px-0'>
        ...
        >
          <div
            style={{ backgroundImage: `url(${getRandomOceanImage()})` }}
            className={cn('absolute inset-0 bg-zinc-900', 'bg-cover bg-center')}
          >
          ...
          <div className='relative z-20 mt-auto'>
            <blockquote className='space-y-2'>
              <p className='text-lg'>
                ...
                helped me deliver information to my students faster than ever
                before.&rdquo;
              </p>
              <footer className='text-sm'>Beyoncé Knowles</footer>
            </blockquote>
          </div>
        </div>
