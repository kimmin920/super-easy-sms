...
function Customizer() {
  ...
  const [darkLightTheme, setdarkLightTheme] = useTheme();
      ...
      <div className='flex items-start pt-4 md:pt-0'>
        <div className='space-y-1 pr-2'>
          ...
          <div className='text-xs text-muted-foreground'>
            Pick a style and color for your application.
          </div>
        </div>
        <Button
          variant='ghost'
                  ...
                  style={
                    {
                      '--theme-primary': `hsl(${
                        theme?.activeColor[
                          darkLightTheme === 'dark' ? 'dark' : 'light'
                        ]
                      })`,
            ...
            {mounted ? (
              <>
                <Button
                  variant={'outline'}
                  size='sm'
                  onClick={() => setdarkLightTheme(Theme.LIGHT)}
                  className={cn(
                    darkLightTheme === 'light' && 'border-2 border-primary'
                  )}
                >
                ...
                <Button
                  variant={'outline'}
                  size='sm'
                  onClick={() => setdarkLightTheme(Theme.DARK)}
                  className={cn(
                    darkLightTheme === 'dark' && 'border-2 border-primary'
                  )}
                >
