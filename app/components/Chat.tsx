      ...
      <Card>
        ...
        <CardContent>
          <div className='space-y-4'>
            ...
            {isGPTLoading && (
              <div className='flex w-max max-w-[75%] flex-col gap-2 rounded-lg px-3 py-2 bg-muted'>
                <Icons.spinner className='animate-spin max-h[24px] stroke-1' />
              </div>
            )}
          </div>
        </CardContent>
        ...
        <CardFooter>
          ...
          >
            ...
            <Button
              type='submit'
              size='icon'
              disabled={inputLength === 0 || isGPTLoading}
            >
              {isGPTLoading ? (
                <Icons.spinner className='animate-spin max-h[24px] stroke-1' />
              ) : (
